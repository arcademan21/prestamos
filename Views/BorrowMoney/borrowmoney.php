      ...
      <div class="tile">
        <div class="bs-component">
          <ul class="nav nav-tabs">
            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#exists"><i class="fas fa-clipboard-list"></i> Cliente de la lista</a></li>
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#new"><i class="fas fas fa-plus-circle"></i> Cliente nuevo</a></li>
          ...
          <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade active show" id="exists">
                  ...
                  <form id="old-loan-form">
                    ...
                    <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <input type="number" class="form-control" id="initial_loan_exists" step="0.01" style="position: relative; float: left; width: 65%;"  required> 
                          <span style="position: relative; float: left; font-size: 25px; margin-left: 5px;">€</span>
                        </div>

                        <div class="col-md-2">
                          <input type="number" class="form-control" id="interst_exists" value="10" step="0.01" placeholder="10%" style="position: relative; float: left; width: 65%;" required> 
                          <span style="position: relative; float: left; font-size: 25px; margin-left: 5px;">%</span>
                        </div>
                  ...
                  <form id="new-loan-form" style="padding: 25px 0;">
                    ...
                    <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <input type="number" class="form-control" id="initial_loan" step="0.01" placeholder="0" style="position: relative; float: left; width: 65%;"  required> 
                          <span style="position: relative; float: left; font-size: 25px; margin-left: 5px;">€</span>
                        </div>

                        <div class="col-md-2">
                          <input type="number" class="form-control" value="10" id="interest" step="0.01" placeholder="10%" style="position: relative; float: left; width: 65%;" required> 
                          <span style="position: relative; float: left; font-size: 25px; margin-left: 5px;">%</span>
                        </div>
